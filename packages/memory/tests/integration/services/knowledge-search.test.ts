...
describe("search handler", () => {
  ...
  const seedData = [
    ...
    },
    {
      ...
      content:
        "All services should receive their dependencies through constructor injection. This makes unit testing easier.",
    ...
    },
    {
      ...
      content:
        "In this project we use URL-based versioning for APIs. All endpoints prefixed with /v1/, /v2/, etc.",
      tags: ["api", "versioning"],
      scope: "project:myapp",
    },
  ];
  ...
  describe("ranking", () => {
    it("executes broad SQL and exposes token coverage for partial sentence matches", () => {
      ...
      const { sql, params } = buildBroadSearchQuery(
        buildBroadFtsQuery(query),
        tokens,
        undefined,
        10,
      );
