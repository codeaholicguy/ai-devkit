  ...
  inputSchema: {
    ...
    properties: {
      ...
      content: {
        type: "string",
        description:
          "Detailed explanation in markdown format. Supports code blocks and examples. (50-5000 chars)",
      },
      tags: {
        type: "array",
        items: { type: "string" },
      ...
      scope: {
        type: "string",
        description:
          'Optional scope: "global", "project:<name>", or "repo:<name>". Default: "global"',
      },
    },
  ...
  inputSchema: {
    ...
    properties: {
      ...
      scope: {
        type: "string",
        description:
          'New scope: "global", "project:<name>", or "repo:<name>". Only provide if changing.',
      },
    },
    required: ["id"],
  },
  ...
  inputSchema: {
    ...
    properties: {
      query: {
        type: "string",
        description:
          "Natural language task description to search for relevant knowledge (3-500 chars)",
      },
      contextTags: {
        type: "array",
        items: { type: "string" },
...
export function createServer(): Server {
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
      ...
      const errorResponse =
        error instanceof KnowledgeMemoryError
          ? error.toJSON()
          : {
