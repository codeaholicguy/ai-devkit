...
export function memorySearchCommand(options: MemorySearchOptions): SearchKnowledgeResult {
  return withMemoryDatabase(options.dbPath, () =>
    searchKnowledge(toSearchInput(options, { includeExplain: false })),
  );
}

export async function memorySearchCommandAsync(
...
export async function memoryStoreCommandAsync(
  options: MemoryStoreOptions & { semantic?: boolean },
...
export async function memoryUpdateCommandAsync(
  options: MemoryUpdateOptions & { semantic?: boolean },
...
export async function memorySemanticStatusCommand(
  options: MemorySemanticOptions = {},
): Promise<SemanticStatusResult> {
  return withMemoryDatabaseAsync(options.dbPath, () => getSemanticStatus());
}

export async function memoryDownloadSemanticCommand(
  options: MemorySemanticOptions = {},
): Promise<SemanticStatusResult> {
  return withMemoryDatabaseAsync(options.dbPath, () => downloadSemanticModel());
}

export async function memoryReembedCommand(
  options: MemoryReembedOptions = {},
...
async function withMemoryDatabaseAsync<T>(
