...
vi.mock("../../../../services/install/mcp/ClaudeCodeMcpGenerator.js", () => ({
  ClaudeCodeMcpGenerator: vi.fn().mockImplementation(function () {
    return {
...
vi.mock("../../../../services/install/mcp/CodexMcpGenerator.js", () => ({
  CodexMcpGenerator: vi.fn().mockImplementation(function () {
    return {
...
vi.mock("../../../../services/install/mcp/JunieMcpGenerator.js", () => ({
  JunieMcpGenerator: vi.fn().mockImplementation(function () {
    return {
...
vi.mock("../../../../services/install/mcp/GitHubCopilotMcpGenerator.js", () => ({
  GitHubCopilotMcpGenerator: vi.fn().mockImplementation(function () {
    return {
...
vi.mock("../../../../services/install/mcp/DevinMcpGenerator.js", () => ({
  DevinMcpGenerator: vi.fn().mockImplementation(function () {
    return {
...
vi.mock("../../../../services/install/mcp/RooCodeMcpGenerator.js", () => ({
  RooCodeMcpGenerator: vi.fn().mockImplementation(function () {
    return {
...
vi.mock("../../../../services/install/mcp/KiloCodeMcpGenerator.js", () => ({
  KiloCodeMcpGenerator: vi.fn().mockImplementation(function () {
    return {
...
vi.mock("../../../../services/install/mcp/OpenCodeMcpGenerator.js", () => ({
  OpenCodeMcpGenerator: vi.fn().mockImplementation(function () {
    return {
