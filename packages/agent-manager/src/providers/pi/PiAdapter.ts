...
export class PiAdapter implements AgentAdapter {
    ...
    async detectAgents(context?: AgentDetectionContext): Promise<AgentInfo[]> {
        ...
        const unmatchedProcesses = this.findUnmatchedProcesses(locatorResult.fallback, legacyResult.agents);
    ...
    private mapLegacyMatches(matches: Array<{ process: ProcessInfo; session: { filePath: string } }>): MappedAgentResult {
