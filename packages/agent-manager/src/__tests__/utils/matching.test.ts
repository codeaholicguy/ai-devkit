...
describe("matchProcessesToSessions", () => {
  ...
  it("should match a single process to closest session", () => {
    ...
    const s2 = makeSession({
      sessionId: "s2",
      birthtimeMs: new Date("2026-03-18T23:20:00.000Z").getTime(),
    });
  ...
  it("should enforce 1:1 constraint — each process matches only one session", () => {
    ...
    const s1 = makeSession({
      sessionId: "s1",
      birthtimeMs: new Date("2026-03-18T23:18:10.000Z").getTime(),
    });
    const s2 = makeSession({
      sessionId: "s2",
      birthtimeMs: new Date("2026-03-18T23:18:35.000Z").getTime(),
    });
  ...
  it("should disambiguate multiple processes with same CWD by birthtime", () => {
    ...
    const s2 = makeSession({
      sessionId: "s2",
      birthtimeMs: new Date("2026-03-19T08:55:35.000Z").getTime(),
    });
  ...
  it("should handle more sessions than processes", () => {
    ...
    const s2 = makeSession({
      sessionId: "s2",
      birthtimeMs: new Date("2026-03-18T23:19:00.000Z").getTime(),
    });
    const s3 = makeSession({
      sessionId: "s3",
      birthtimeMs: new Date("2026-03-18T23:19:30.000Z").getTime(),
    });
  ...
  it("should prefer best match when greedy ordering matters", () => {
    ...
    const s1 = makeSession({
      sessionId: "s1",
      birthtimeMs: new Date("2026-03-18T23:18:08.000Z").getTime(),
    });
    const s2 = makeSession({
      sessionId: "s2",
      birthtimeMs: new Date("2026-03-18T23:18:30.000Z").getTime(),
    });
