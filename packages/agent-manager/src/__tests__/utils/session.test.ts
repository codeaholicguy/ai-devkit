...
describe("batchGetSessionFileBirthtimes", () => {
  ...
  it("should parse session files correctly", () => {
    mockedReaddirSync.mockReturnValue(["abc123.jsonl", "def456.jsonl"] as unknown as ReturnType<
  ...
  it("should skip non-jsonl files", () => {
    ...
    mockedStatSync.mockReturnValueOnce({ birthtimeMs: 1710800500000 } as fs.Stats);
  ...
  it("should handle UUID session IDs", () => {
    ...
    mockedStatSync.mockReturnValueOnce({ birthtimeMs: 1710800324000 } as fs.Stats);
  ...
  it("should leave resolvedCwd empty", () => {
    mockedReaddirSync.mockReturnValue(["abc.jsonl"] as unknown as ReturnType<
      typeof fs.readdirSync
    >);
    mockedStatSync.mockReturnValueOnce({ birthtimeMs: 1710800324000 } as fs.Stats);
  ...
  it("should enumerate multiple directories", () => {
    mockedReaddirSync
      .mockReturnValueOnce(["sess1.jsonl", "sess3.jsonl"] as unknown as ReturnType<
        typeof fs.readdirSync
      >)
      .mockReturnValueOnce(["sess2.jsonl"] as unknown as ReturnType<typeof fs.readdirSync>);
    mockedStatSync
      .mockReturnValueOnce({ birthtimeMs: 1710800324000 } as fs.Stats)
      .mockReturnValueOnce({ birthtimeMs: 1710800500000 } as fs.Stats)
  ...
  it("should skip files where statSync fails", () => {
    mockedReaddirSync.mockReturnValue(["good.jsonl", "gone.jsonl"] as unknown as ReturnType<
      typeof fs.readdirSync
    >);
    mockedStatSync
      .mockReturnValueOnce({ birthtimeMs: 1710800324000 } as fs.Stats)
